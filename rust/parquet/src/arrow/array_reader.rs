...
use arrow::datatypes::{
    ...
    IntervalDayTimeType as ArrowIntervalDayTimeType, IntervalUnit,
    IntervalYearMonthType as ArrowIntervalYearMonthType, Schema,
    ...
    fn build_for_primitive_type_inner(
        ...
        if let Some(ArrowType::Dictionary(key_type, value_type)) = arrow_type {
            match cur_type.get_physical_type() {
                ...
                PhysicalType::INT32 => {
                    macro_rules! convert_primitive_dictionary {
                        ($(($kt: pat, $akt: ident, $vt: pat, $avt: ident),)*) => (
                            match (&**key_type, &**value_type) {
                                $(($kt, $vt) => {
                                    let converter = PrimitiveDictionaryConverter::<$akt, $avt>::new(DictionaryArrayConverter::new());

                                    return Ok(Box::new(ComplexObjectArrayReader::<
                                        Int32Type,
                                        _,
                                    >::new(
                    ...
                    convert_primitive_dictionary!(
                        ...
                        (
                            ...
                            ArrowTime32SecondType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Time32(TimeUnit::Millisecond),
                            ArrowTime32MillisecondType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                        ...
                        (
                            ...
                            ArrowTime64NanosecondType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Interval(IntervalUnit::YearMonth),
                            ArrowIntervalYearMonthType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Interval(IntervalUnit::DayTime),
                            ArrowIntervalDayTimeType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Duration(TimeUnit::Second),
                            ArrowDurationSecondType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Duration(TimeUnit::Millisecond),
                            ArrowDurationMillisecondType
                        ),
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                        ...
                        (
                            ArrowType::Int8,
                            ArrowInt8Type,
                            ArrowType::Duration(TimeUnit::Nanosecond),
                            ArrowDurationNanosecondType
                        ),
                        // Key: Int16
                        (
                            ArrowType::Int16,
